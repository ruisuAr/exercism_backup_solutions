...
namespace estate_executor {
    int assemble_account_number(int secret_modifier) {
        int sum_number_bank{zhang::bank_number_part(secret_modifier)+khan::bank_number_part(secret_modifier)+garcia::bank_number_part(secret_modifier)};
        return sum_number_bank;
    }
    int assemble_code() {
        int sum_blue_code{zhang::blue::code_fragment()+khan::blue::code_fragment()+garcia::blue::code_fragment()};
        int sum_red_code{zhang::red::code_fragment()+khan::red::code_fragment()+garcia::red::code_fragment()};
        int multiply_codes{sum_blue_code * sum_red_code};

        return multiply_codes;
    }
}